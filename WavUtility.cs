...
// For Mac OS			
			...
			string macDocPath = Application.persistentDataPath + "/../../../../Documents";
			filepath = string.Format ("{0}/{1}/{2}.{3}", macDocPath, dirname, DateTime.Now.ToString("yyyyMMdd-HHmmss-fff"), "mp3");
#endif

// For Windows 
#if UNITY_STANDALONE_WIN
			string winDocPath = Application.persistentDataPath + "/../../../../Documents";
			filepath = string.Format (@"{0}\{1}\{2}.{3}", winDocPath, dirname, DateTime.Now.ToString("yyyyMMdd-HHmmss-fff"), "mp3");
#endif
