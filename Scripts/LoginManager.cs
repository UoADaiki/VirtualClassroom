...
public class LoginManager : MonoBehaviourPunCallbacks
{
    ...
    public override void OnJoinedRoom(){
        ...
        if(isTeacher == true){
            ...
            Vector3 avatarPos = teacher.transform.position;
            Vector3 cameraPos = new Vector3(avatarPos.x + (0.5f * teacher.transform.forward.x), avatarPos.y + 1.0f, avatarPos.z + (0.8f * teacher.transform.forward.z));
            mainCamera.transform.parent = teacher.transform;
            ...
            Vector3 avatarPos = student.transform.position;
            Vector3 cameraPos = new Vector3(avatarPos.x + (0.5f * student.transform.forward.x), avatarPos.y + 1.0f, avatarPos.z + (0.8f * student.transform.forward.z));
            mainCamera.transform.parent = student.transform;
            mainCamera.transform.position = cameraPos;
        }
